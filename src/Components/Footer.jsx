...
export const Footer = () => {
    return (
        <>
            <footer className="2xl:px-40 xl:px-20 md:px-10 sm:px-6 px-4 py-4 bg-black text-white">
                ...
                <div className="flex flex-col md:flex-row items-center justify-between gap-6">
                    ...
                    <div className="flex gap-12">
                        ...
                        <a href="https://www.linkedin.com/in/juhi-pawar-65471a206" target="_blank">
                            <svg className="w-8 " fill="currentColor" viewBox="0 0 24 24">
                ...
                {/* ---- COPYRIGHT ---- */}
                <div>
                    <p className=" text-sm mt-6 font-inter text-center ">
